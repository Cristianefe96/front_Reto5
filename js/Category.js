function traerInformacionCategoria(){
    //console.log("test");
        $.ajax({
        url:"http://129.151.121.47:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategoria(){
    ...
    let var2 = {
        ...
        url:"http://129.151.121.47:8080/api/Category/save",
...
function actualizarInformacionCategoria(idElemento){
    ...
    $.ajax({
        url:"http://129.151.121.47:8080/api/Category/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    $.ajax({
        url:"http://129.151.121.47:8080/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
